...
var ConciseReporter = function (_events$EventEmitter) {
  ...
  _createClass(ConciseReporter, [{
    ...
    value: function prepareConsole(jsonReport) {
      var version = jsonReport.capabilities.version || jsonReport.capabilities.browser_version;
      var platform = jsonReport.capabilities.platform || jsonReport.capabilities.os + ':' + (jsonReport.capabilities.os_version || 'latest');
      var resolution = jsonReport.capabilities.screenResolution || jsonReport.capabilities.resolution;

      var mainMessage = ' ' + (jsonReport.capabilities.browserName || jsonReport.capabilities.deviceName);
